...
public class AdapterADDMLong extends RecyclerView.Adapter<AdapterADDMLong.ViewHolder> {
    private String TAG = AdapterADDMLong.class.getSimpleName();
    ...
    public AdapterADDMLong(Context context, List<Long> tdp, List<Long> cicilan,
                ...
                tv_tenor.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            SelectedData.Dp = String.valueOf(dpMurni);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.bindHolder(tdp.get(position),cicilan.get(position), tenors.get(position).getName(),position,dpMurni.get(position),dpMurniPercentage.get(position));
    }
