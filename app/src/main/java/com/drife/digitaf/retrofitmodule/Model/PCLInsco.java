...
public class PCLInsco {
    ...
    @SerializedName("pcl_premi")
    private PCLPremi pcl_premi;
    ...
    public PCLPremi getPcl_premi() {
        return pcl_premi;
    }

    public void setPcl_premi(PCLPremi pcl_premi) {
        this.pcl_premi = pcl_premi;
    }
}
