...
public class MaritalStatus extends SugarRecord implements Serializable{
    ...
    public MaritalStatus(String wayOfPaymentId, String code, String name, String description, String createdBy, String modifiedBy, String isActive, String isActiveConfins, String createdAt, String updatedAt, String deletedAt) {
