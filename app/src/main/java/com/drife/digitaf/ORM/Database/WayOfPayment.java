...
public class WayOfPayment extends SugarRecord implements Serializable{
    ...
    public WayOfPayment(String wayOfPaymentId, String code, String name, String description, String createdBy, String modifiedBy, String isActive, String isActiveConfins, String createdAt, String updatedAt, String deletedAt) {
